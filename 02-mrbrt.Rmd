...
```{r message=FALSE}
library(dplyr)
# library(mrbrt001, lib.loc = "/ihme/code/mscm/R/packages/") # for R version 3
library(mrbrt002, lib.loc = "/ihme/code/mscm/Rv4/packages/") # for R version 4
...
## Visualizing evidence score results {#section8}
